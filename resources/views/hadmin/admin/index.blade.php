    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem" href="{{url('hadmin/index_v1')}}">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('hadmin/goods_cat')}}">商品分类</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('hadmin/goods')}}">添加商品</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('hadmin/goods_stock_list')}}">商品展示</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('hadmin/goods_attribute')}}">添加商品属性</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('hadmin/goods_type')}}">添加商品类型</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="{{url('hadmin/index_v1')}}" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
