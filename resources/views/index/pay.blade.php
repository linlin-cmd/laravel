  ...
  <body>
    <div class="maincont">
     ...
     <form action="">
      <table>
       <tr>
        收货人:{{$address->address_name}} 联系电话:{{$address->tel}}
       ...
       <tr>
        ...
        <td align="right"><strong class="orange">¥{{$total[0]->total}}</strong></td>
       </tr>
       <tr>
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       ...
       <td width="50%">总计：<strong class="orange">¥{{$total[0]->total}}</strong></td>
       <td width="40%"><a href="javascript:void(0)" onclick="jiesuan()" class="jiesuan">提交订单</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
    </div><!--maincont-->
